...
public class TraceTest extends AbstractTraceTest {
    ...
    public static class TestFilter3 {
        ...
        public void doFilter() {
            ...
            System.out.println(po.test((byte) 0, 'a', (short) 1, 2, 3L, 4.4f, 5, true, "aaa", null));
...
//            super(10);
        ...
        public Date test(byte v0, char c, short v1, int v2, long v3, float v4, double v5, boolean v6, String v7, Date d) {
            Base b = new Impl();
            b.doIt();
            return new Date();
        }
